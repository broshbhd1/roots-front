...
export const TeamCadetsList = ({
  ...
  const swipeRightContent = (
    <div className={cx(styles.swipeRightContent, styles.swipeableContent)}>
  ...
  const swipeLeftContent = (
    <div className={cx(styles.swipeLeftContent, styles.swipeableContent)}>
      <Slide direction="up" in={isSliding}>
